...
!function(a,b){"function"==typeof define&&define.amd?define(b):a.Meny=b()}(this,function(){"function"!=typeof Date.now&&(Date.now=function(){return(new Date).getTime()});var a={create:function(b){return function(){function G(b){a.extend(h,b),H(),I(),J(),K(),L(),M()}function H(){switch(t="",x="",menuAngle=h.angle,contentsAngle=h.angle/-2,h.position){case c:r="50% 0%",s="rotateX( "+menuAngle+"deg ) translateY( -100% ) translateY( "+h.overlap+"px )",w="50% 0",y="translateY( "+h.height+"px ) rotateX( "+contentsAngle+"deg )",u={top:"-"+(h.height-h.overlap)+"px"},v={top:"0px"},z={top:"0px"},A={top:h.height+"px"};break;case d:r="100% 50%",s="rotateY( "+menuAngle+"deg ) translateX( 100% ) translateX( -2px ) scale( 1.01 )",w="100% 50%",y="translateX( -"+h.width+"px ) rotateY( "+contentsAngle+"deg )",u={right:"-"+(h.width-h.overlap)+"px"},v={right:"0px"},z={left:"0px"},A={left:"-"+h.width+"px"};break;case e:r="50% 100%",s="rotateX( "+-menuAngle+"deg ) translateY( 100% ) translateY( -"+h.overlap+"px )",w="50% 100%",y="translateY( -"+h.height+"px ) rotateX( "+-contentsAngle+"deg )",u={bottom:"-"+(h.height-h.overlap)+"px"},v={bottom:"0px"},z={top:"0px"},A={top:"-"+h.height+"px"};break;default:r="100% 50%",s="translateX( -100% ) translateX( "+h.overlap+"px ) scale( 1.01 ) rotateY( "+-menuAngle+"deg )",w="0 50%",y="translateX( "+h.width+"px ) rotateY( "+-contentsAngle+"deg )",u={left:"-"+(h.width-h.overlap)+"px"},v={left:"0px"},z={left:"0px"},A={left:h.width+"px"}}}function I(){a.addClass(i.wrapper,"meny-"+h.position),B.wrapper=i.wrapper.style.cssText,i.wrapper.style[a.prefix("perspective")]="800px",i.wrapper.style[a.prefix("perspectiveOrigin")]=w}function J(){i.cover&&i.cover.parentNode.removeChild(i.cover),i.cover=document.createElement("div"),i.cover.style.position="absolute",i.cover.style.display="block",i.cover.style.width="100%",i.cover.style.height="100%",i.cover.style.left=0,i.cover.style.top=0,i.cover.style.zIndex=1e3,i.cover.style.visibility="hidden",i.cover.style.opacity=0;try{i.cover.style.background="rgba( 0, 0, 0, 0.4 )",i.cover.style.background="-ms-linear-gradient("+h.position+","+h.gradient,i.cover.style.background="-moz-linear-gradient("+h.position+","+h.gradient,i.cover.style.background="-webkit-linear-gradient("+h.position+","+h.gradient}catch(a){}g&&(i.cover.style[a.prefix("transition")]="all "+h.transitionDuration+" "+h.transitionEasing),i.contents.appendChild(i.cover)}function K(){var b=i.menu.style;switch(h.position){case c:b.width="100%",b.height=h.height+"px";break;case d:b.right="0",b.width=h.width+"px",b.height="100%";break;case e:b.bottom="0",b.width="100%",b.height=h.height+"px";break;case f:b.width=h.width+"px",b.height=$(window).height()-3+"px"}B.menu=b.cssText,b.position="fixed",b.display="block",b.zIndex=1,g?(b[a.prefix("transform")]=s,b[a.prefix("transformOrigin")]=r,b[a.prefix("transition")]="all "+h.transitionDuration+" "+h.transitionEasing):a.extend(b,u)}function L(){var b=i.contents.style;B.contents=b.cssText,g?(b[a.prefix("transform")]=x,b[a.prefix("transformOrigin")]=w,b[a.prefix("transition")]="all "+h.transitionDuration+" "+h.transitionEasing):(b.position=b.position.match(/relative|absolute|fixed/gi)?b.position:"relative",a.extend(b,z))}function M(){"ontouchstart"in window&&(h.touch?(a.bindEvent(document,"touchstart",T),a.bindEvent(document,"touchend",V)):(a.unbindEvent(document,"touchstart",T),a.unbindEvent(document,"touchend",V))),h.mouse?(a.bindEvent(document,"mousedown",Q),a.bindEvent(document,"mouseup",S),a.bindEvent(document,"mousemove",R)):(a.unbindEvent(document,"mousedown",Q),a.unbindEvent(document,"mouseup",S),a.unbindEvent(document,"mousemove",R))}function N(){p||(p=!0,a.addClass(i.wrapper,"meny-active"),i.cover.style.height=i.contents.scrollHeight+"px",i.cover.style.visibility="visible",g?(a.bindEventOnce(i.wrapper,"transitionend",function(){a.dispatchEvent(i.menu,"opened")}),i.cover.style.opacity=1,i.contents.style[a.prefix("transform")]=y,i.menu.style[a.prefix("transform")]=t):(D&&D.stop(),D=a.animate(i.menu,v,500),E&&E.stop(),E=a.animate(i.contents,A,500),F&&F.stop(),F=a.animate(i.cover,{opacity:1},500)),a.dispatchEvent(i.menu,"open"))}function O(){p&&(p=!1,a.removeClass(i.wrapper,"meny-active"),g?(a.bindEventOnce(i.wrapper,"transitionend",function(){a.dispatchEvent(i.menu,"closed")}),i.cover.style.visibility="hidden",i.cover.style.opacity=0,i.contents.style[a.prefix("transform")]=x,i.menu.style[a.prefix("transform")]=s):(D&&D.stop(),D=a.animate(i.menu,u,500),E&&E.stop(),E=a.animate(i.contents,z,500),F&&F.stop(),F=a.animate(i.cover,{opacity:0},500,function(){i.cover.style.visibility="hidden",a.dispatchEvent(i.menu,"closed")})),a.dispatchEvent(i.menu,"close"))}function P(){i.wrapper.style.cssText=B.wrapper,i.menu.style.cssText=B.menu,i.contents.style.cssText=B.contents,i.cover&&i.cover.parentNode&&i.cover.parentNode.removeChild(i.cover),a.unbindEvent(document,"touchstart",T),a.unbindEvent(document,"touchend",V),a.unbindEvent(document,"mousedown",Q),a.unbindEvent(document,"mouseup",S),a.unbindEvent(document,"mousemove",R);for(var b in C)this.removeEventListener(C[b][0],C[b][1]);C=[]}function Q(a){q=!0}function R(a){if(!q){var b=a.clientX-j,g=a.clientY-k;switch(h.position){case c:g>h.height?O():g<h.threshold&&N();break;case d:var l=i.wrapper.offsetWidth;b<l-h.width?O():b>l-h.threshold&&N();break;case e:var m=i.wrapper.offsetHeight;g<m-h.height?O():g>m-h.threshold&&N();break;case f:b>h.width?O():b<h.threshold&&N()}}}function S(a){q=!1}function T(b){l=b.touches[0].clientX-j,m=b.touches[0].clientY-k,n=null,o=null,a.bindEvent(document,"touchmove",U)}function U(a){n=a.touches[0].clientX-j,o=a.touches[0].clientY-k;var b=null;Math.abs(n-l)>Math.abs(o-m)?n<l-h.threshold?b=Y:n>l+h.threshold&&(b=X):o<m-h.threshold?b=_:o>m+h.threshold&&(b=Z),b&&b()&&a.preventDefault()}function V(b){a.unbindEvent(document,"touchmove",U),null===n&&null===o&&W()}function W(){var a=h.position===c&&m>h.height||h.position===d&&l<i.wrapper.offsetWidth-h.width||h.position===e&&m<i.wrapper.offsetHeight-h.height||h.position===f&&l>h.width;a&&O()}function X(){return h.position===d&&p?(O(),!0):h.position!==f||p?void 0:(N(),!0)}function Y(){return h.position!==d||p?h.position===f&&p?(O(),!0):void 0:(N(),!0)}function Z(){return h.position===e&&p?(O(),!0):h.position!==c||p?void 0:(N(),!0)}function _(){return h.position!==e||p?h.position===c&&p?(O(),!0):void 0:(N(),!0)}if(!b||!b.menuElement||!b.contentsElement)throw"You need to specify which menu and contents elements to use.";if(b.menuElement.parentNode!==b.contentsElement.parentNode)throw"The menu and contents elements must have the same parent.";var r,s,t,u,v,w,x,y,z,A,D,E,F,c="top",d="right",e="bottom",f="left",g="WebkitPerspective"in document.body.style||"MozPerspective"in document.body.style||"msPerspective"in document.body.style||"OPerspective"in document.body.style||"perspective"in document.body.style,h={width:300,height:300,position:f,threshold:40,angle:30,overlap:6,transitionDuration:"0.5s",transitionEasing:"ease",gradient:"rgba(0,0,0,0.20) 0%, rgba(0,0,0,0.65) 100%)",mouse:!0,touch:!0},i={menu:b.menuElement,contents:b.contentsElement,wrapper:b.menuElement.parentNode,cover:null},j=i.wrapper.offsetLeft,k=i.wrapper.offsetTop,l=null,m=null,n=null,o=null,p=!1,q=!1,B={},C=[];return G(b),{configure:G,open:N,close:O,destroy:P,isOpen:function(){return p},addEventListener:function(b,c){C.push([b,c]),i.menu&&a.bindEvent(i.menu,b,c)},removeEventListener:function(b,c){i.menu&&a.unbindEvent(i.menu,b,c)}}}()},animate:function(a,b,c,d){return function(){function i(){var b=1-Math.pow(1-(Date.now()-g)/c,5);for(var f in e){var k=e[f];a.style[f]=k.start+(k.end-k.start)*b+k.unit}b<1?h=setTimeout(i,1e3/60):(d&&d(),j())}function j(){clearTimeout(h)}var e={};for(var f in b)e[f]={start:parseFloat(a.style[f])||0,end:parseFloat(b[f]),unit:"string"==typeof b[f]&&b[f].match(/px|em|%/gi)?b[f].match(/px|em|%/gi)[0]:""};var h,g=Date.now();return i(),{stop:j}}()},extend:function(a,b){for(var c in b)a[c]=b[c]},prefix:function(a,b){for(var c=a.slice(0,1).toUpperCase()+a.slice(1),d=["Webkit","Moz","O","ms"],e=0,f=d.length;e<f;e++){var g=d[e];if("undefined"!=typeof(b||document.body).style[g+c])return g+c}return a},addClass:function(a,b){a.className=a.className.replace(/\s+$/gi,"")+" "+b},removeClass:function(a,b){a.className=a.className.replace(b,"")},bindEvent:function(a,b,c){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent("on"+b,c)},unbindEvent:function(a,b,c){a.removeEventListener?a.removeEventListener(b,c,!1):a.detachEvent("on"+b,c)},bindEventOnce:function(a,b,c){var d=this,e=function(){d.unbindEvent(a,b,e),c.apply(this,arguments)};this.bindEvent(a,b,e)},dispatchEvent:function(b,c,d){if(b){var e=document.createEvent("HTMLEvents",1,2);e.initEvent(c,!0,!0),a.extend(e,d),b.dispatchEvent(e)}},getQuery:function(){var a={};return location.search.replace(/[A-Z0-9]+?=([\w|:|\/\.]*)/gi,function(b){a[b.split("=").shift()]=b.split("=").pop()}),a}};return a});